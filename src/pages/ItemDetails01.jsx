...
const ItemDetails01 = () => {
    ...
    useLayoutEffect(() => {
        ...
        fetch(`https://testnets-api.opensea.io/api/v1/asset/${contract}/${token}/`, options)
        .then(response => response.json())
        .then(response => {setNft(response); console.log(response)})
                                        ...
                                        <div className="meta-info">
                                            <div className="author">
                                                <div className="avatar">
                                                    <img src={nft?.owner?.profile_img_url} alt="Axies" />
                                                </div>
                                                <div className="info">
                                                    <span>Owned By</span>
                                                    <h6> {nft?.owner?.user?.username} </h6>
                                                </div>
                                            </div>
                                        </div>
                                        {/* <div className="meta-info">
                                            <div className="author">
                                                <div className="avatar">
                                                    <img src={nft?.top_ownerships?[0]?.owner?.profile_img_url} alt="Axies" />
                                                </div>
                                                <div className="info">
                                                    <span>Create By</span>
                                                    <h6> {nft?.top_ownerships?[0]?.owner?.user?.username} </h6>
                                                </div>
                                            </div>
                                        </div> */}
                                    </div>
                                        ...
                                        <div className="item meta-price">
                                            ...
                                            <div className="price">
                                                <div className="price-box">
                                                    <h5> {nft?.last_sale?.payment_token?.eth_price ? parseFloat(nft?.last_sale?.payment_token?.eth_price) : "-"} ETH</h5>
                                                    <span>= ${nft?.last_sale?.payment_token?.usd_price ? parseFloat(nft?.last_sale?.payment_token?.usd_price) : "-"}</span>
                                                </div>
                                            </div>
                                        </div>
